              ...
              <form action="{{url('updateproduct/'.$edit->id)}}" method="post">
                ...
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Product Update</label>
                    <input type="text" name="productname" class="form-control" value="{{$edit->productname }}"id="exampleInputEmail1" placeholder="Enter Product">
                  </div>
